    ...
    return ReactDom.createPortal(
        ...
        { movieInfo && (
                ...
                <Modal onClick={(event) => {event.stopPropagation()}}>
                    ...
                    <ContainerImg><img src={movieInfo.poster_path ? `https://image.tmdb.org/t/p/w500/${movieInfo.poster_path}` : defaultImg} alt={movieInfo.title || movieInfo.name} /></ContainerImg>
